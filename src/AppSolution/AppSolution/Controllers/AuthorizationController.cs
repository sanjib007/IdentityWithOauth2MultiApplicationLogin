...
namespace AppSolution.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        public AuthorizationController(SignInManager<AppUser> signInManager, UserManager<AppUser> userManager,
            IServiceProvider serviceProvider, AppDBContext applicationDbContext, IOpenIddictScopeManager scopeManager)
        {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterViewModel model)
        {
            ...
            {
                var oldUser = await _userManager.FindByNameAsync(model.Email);
                if (oldUser != null)
                {
                ...
                {
                    return Ok("User Insert Successful.");
                }
                AddErrors(result);
            }
